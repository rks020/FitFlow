...
// Converted from Flutter app's turkey_cities.dart
...
export const CITIES_AND_DISTRICTS = {
    ...
    'Konya': ['Ahırlı', 'Akören', 'Akşehir', 'Altınekin', 'Beyşehir', 'Bozkır', 'Çeltik', 'Çumra', 'Derbent', 'Derebucak', 'Doğanhisar', 'Emirgazi', 'Ereğli', 'Güneysınır', 'Hadim', 'Halkapınar', 'Hüyük', 'Ilgın', 'Kadınhanı', 'Karapınar', 'Karatay', 'Kulu', 'Meram', 'Sarayönü', 'Selçuklu', 'Seydişehir', 'Taşkent', 'Tuzlukçu', 'Yalıhüyük', 'Yunak'],
...
export function getCityNames() {
    return Object.keys(CITIES_AND_DISTRICTS).sort();
}

// Get districts for a specific city
export function getDistricts(city) {
    return CITIES_AND_DISTRICTS[city] || [];
}

// Search cities (case-insensitive)
export function searchCities(query) {
    if (!query) return getCityNames();
