...
enum ConflictAction { modifyTime, skip, cancel, acceptAlternative, proceedAnyway, proceedAll }
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    CustomButton(
                      text: 'Hepsini Yine de Ekle',
                      onPressed: () => Navigator.pop(context, ConflictAction.proceedAll),
                      backgroundColor: AppColors.accentOrange,
                      foregroundColor: Colors.white,
                      isOutlined: true,
                    ),
